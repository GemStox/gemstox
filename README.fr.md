...
GemStox est un moteur de signaux boursiers mathématiquement prouvé. Il transforme les données brutes du marché en signaux d'achat/vente clairs — avec un taux de filtrage du bruit de 99%. Aucun diplôme en finance requis.

- Plusieurs classes de stratégie — momentum, valeur, breakout, mean-reversion
- Filtre de bruit à 99% — supprime les alertes inutiles, ne montre que les configurations probables
